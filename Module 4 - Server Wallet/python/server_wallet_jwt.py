...
# Generates a Bearer JWT for CDP Server Wallet v2 REST endpoints
# Env vars required:
...
#   REQUEST_PATH: e.g., /platform/v2/evm/accounts
# Optional:
...
def main() -> None:
    ...
    path = os.getenv("REQUEST_PATH", "/platform/v2/evm/accounts")
