...
- **What it is**: Base is Coinbase’s low-fee Ethereum L2, incubated by Coinbase and now open to public builders (https://docs.cdp.coinbase.com/index).  
- **Key Clues**: Questions about RPC endpoints, contract deployment, Base-specific gas sponsorship, or Base Wallet Standard features likely belong to coalition support channels (Base Discord, docs.cdp.coinbase.com).  
- **Redirect Guidance**: Point developers to Base doc links, community Discord, or Base status pages; highlight that CDP handles embedded/server wallets while Base L2 node support lives outside CDP T1.

---

## 2. Coinbase Exchange / Pro (Retail Trading)
...
## 3. Coinbase International Exchange
...
## 9. Redirection Message Templates
